...
# -*- coding: utf-8 -*-
"""
Vibe Coding 深度分析器 - 基于 DeepSeek API (8分类版本)
...
- 严格遵循提示词: 完全使用 LLM提示词_8分类 文件的分类逻辑
- 8分类体系: 企业商业应用/效率工具/技术基础设施/娱乐媒体/教育学习/社交社区/健康医疗/个人生活
...
OUTPUT_JSON = "vibe_coding_analysis_8cat.jsonl"
OUTPUT_CSV = "vibe_coding_analysis_8cat.csv"
...
class AnalysisResult:
    ...
    tier: str
    size_kb: int
    created_at: Optional[str]  # 仓库创建时间
...
- 3: 中等。混合开发，可能使用了 AI 辅助补全代码，但在系统设计和 README 编写上保留了较多个人定制化的人类痕迹。
- 5: 极高。具备明显的 AI 原生特征，例如：根目录包含特定的模型上下文协议文件（如 AGENTS.md, .cursorrules, CLAUDE.md）；或是直接从 Google/Vercel 等官方 AI 模板生成的项目；或是 README 具有高度标准化的机器生成语感。
...
评估项目业务场景的微观维度。必须从以下 8 个选项中精确选择其一：
- 企业商业应用：商业流程自动化、企业管理系统、电商、金融科技、CRM、ERP、销售管理、支付系统等服务于商业运营的场景。
- 效率工具：个人/团队效率工具、开发者工具、内容创作工具、模板/脚手架、编辑器插件、自动化脚本等提升工作效率的场景。
- 技术基础设施：技术研究、原型验证、系统工具、硬件/IoT、操作系统、网络协议、开发框架、中间件等技术底层场景。
- 娱乐媒体：游戏、娱乐消费、媒体播放、内容消费等场景。
- 教育学习：教育平台、学习工具、知识传授、技能提升等场景。
- 社交社区：社交应用、社区平台、通讯工具、约会匹配、论坛、社群运营等场景。
- 健康医疗：医疗应用、健康追踪、wellness、心理健康、健身管理等场景。
- 个人生活：个人生活管理、作品集展示、家庭管理、个人品牌、生活助手等场景。
...
5. micro_scenario: 八选一（企业商业应用/效率工具/技术基础设施/娱乐媒体/教育学习/社交社区/健康医疗/个人生活）
...
只输出合法 JSON，禁止任何额外解释。"""
    ...
    def _parse_response(self, content: str) -> Optional[Dict]:
        ...
        try:
            ...
            valid_micro = [
                "企业商业应用", "效率工具", "技术基础设施", "娱乐媒体",
                "教育学习", "社交社区", "健康医疗", "个人生活"
            ]
            if result['micro_scenario'] not in valid_micro:
                result['micro_scenario'] = "个人生活"  # 默认归为个人生活
        ...
        for attempt in range(MAX_RETRIES):
            ...
            try:
                ...
                analysis = AnalysisResult(
                    ...
                    created_at=repo.get('created_at'),  # 保留创建时间
    ...
    def _print_progress(self) -> None:
        ...
        print("=" * 70)
        print("🚀 Vibe Coding 深度分析器 - DeepSeek API (8分类版本)")
        print("=" * 70)
    ...
    def run(self) -> None:
        ...
        print("=" * 70)
        print("📋 8分类体系:")
        print("   企业商业应用 | 效率工具 | 技术基础设施 | 娱乐媒体")
        print("   教育学习 | 社交社区 | 健康医疗 | 个人生活")
        print("=" * 70)
